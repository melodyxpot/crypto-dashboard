  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-semibold tracking-tight text-balance">Crypto Exchange Dashboard</h1>
          <p className="mt-2 text-sm text-muted-foreground">Real-time cryptocurrency exchange rates</p>
        </div>
        {getConnectionBadge()}
      </div>
          ...
          <Card key={pair.id} className="overflow-hidden border-border bg-card backdrop-blur">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="mt-1 text-xs font-medium text-muted-foreground uppercase tracking-wider">{pair.to}</div>
              </div>
              ...
              <div className="flex items-center justify-between border-t border-border pt-3 text-xs">
                <div>
                  <div className="font-medium text-muted-foreground uppercase tracking-wider">1h Avg</div>
                ...
                <div className="text-right">
                  <div className="font-medium text-muted-foreground uppercase tracking-wider">Last Update</div>
      ...
      {pairs.length === 0 && !error && (
        <div className="flex min-h-[400px] items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-base font-medium text-muted-foreground">Loading exchange rates...</p>
          </div>
        </div>
      )}
    </div>
